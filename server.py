...
class VPNServer:
    ...
    def start(self) -> None:
        ...
        try:
            ...
            self.running = True
            logger.info("VPN Server started on {}:{}".format(self.host, self.port))
    ...
    def handle_client(self, client_socket: ssl.SSLSocket, client_address: Tuple[str, int]) -> None:
        ...
        try:
            ...
            logger.info("Client {} authenticated successfully".format(client_id))
            ...
            while self.running:
                ...
                logger.debug("Received data from {}: {}...".format(client_id, data[:100]))
            ...
            logger.error("Error handling client {}: {}".format(client_id, e))
        finally:
            # Clean up
            ...
            try:
                ...
                pass
            logger.info("Connection with {} closed".format(client_id))
...
def generate_self_signed_cert(cert_file: str, key_file: str) -> None:
    ...
    logger.info("Self-signed certificate generated: {}, {}".format(cert_file, key_file))
...
def main() -> None:
    ...
    if not os.path.exists(args.cert) or not os.path.exists(args.key):
        logger.error("Certificate files not found: {}, {}".format(args.cert, args.key))
